      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="https://api.whatsapp.com/send?phone=558194386948" target="_blank" rel="noopener noreferrer" className="bg-[#176799] text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-[#0a72af] transition-colors flex items-center gap-2">
